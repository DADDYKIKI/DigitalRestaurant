...
public final class PopularDishPageBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static PopularDishPageBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static PopularDishPageBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.popular_dish_page, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static PopularDishPageBinding bind(@NonNull View rootView) {
