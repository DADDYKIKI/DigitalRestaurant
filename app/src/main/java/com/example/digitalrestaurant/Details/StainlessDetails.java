...
public class StainlessDetails implements Serializable {

    private String adafoodName,cusName,adatotalFoodPrice,adaquantity;
    private int phone;

    public StainlessDetails(String adafoodName, String adaquantity,String adatotalFoodPrice, String cusName,int phone) {
